...
var FavoritesPage = /** @class */ (function () {
    function FavoritesPage(rssProvider, navCtrl, navParams) {
        var _this = this;
    ...
    FavoritesPage.prototype.itemTapped = function (event, podcast) {
        // That's right, we're pushing to ourselves!
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__podcast_podcast__["a" /* PodcastPage */], {
            podcast: podcast
        });
    };
    FavoritesPage.prototype.ReFormat = function (title, part) {
        if (part == 0) {
...
var PodcastPage = /** @class */ (function () {
    ...
    PodcastPage.prototype.PlayPodcast = function (podcast, author) {
        ...
        if (podcast.userData.downloaded == true) {
            var location_1 = this.file.dataDirectory + filename;
            console.log('found it, playing from local storage', location_1);
            this.player.Play(location_1, podcast.title, author, podcast.coverImage);
        }
        else {
            var location_2 = podcast.mp3;
            console.log('not downloaded, streaming from internet', location_2);
            this.player.Play(location_2, podcast.title, author, podcast.coverImage);
        }
    };
    ...
    PodcastPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__ionic_native_file__["a" /* File */], __WEBPACK_IMPORTED_MODULE_3__providers_player_player__["a" /* PlayerProvider */], __WEBPACK_IMPORTED_MODULE_4__providers_storage_storage__["a" /* StorageProvider */], __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */]])
    ], PodcastPage);
    return PodcastPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_music_controls__ = __webpack_require__(177);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
